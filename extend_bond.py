...
parser.add_argument('-s', '--still', help='Atom(s) remaining stationary. Give the positions in the \
list of coordinates as a comma-separated list. e.g. 1,2,3,4', 
type = lambda s: [int(item) for item in s.split(',')])
parser.add_argument('-m', '--move', help='Atom(s) to move. Give the positions in the \
list of coordinates as a comma-separated list. e.g. 1,2,3,4', 
type= lambda s: [int(item) for item in s.split(',')])
parser.add_argument('-b', '--by', help='Distance(s) to extend the bond by, in Å. Give the distances \
